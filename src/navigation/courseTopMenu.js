    ...
    return(
      <CourseTopTab.Navigator
        screenOptions={{
            ...
            tabBarStyle: { backgroundColor: 'transparent', marginHorizontal: 20, marginBottom: 20, },
            tabBarIndicatorStyle: {backgroundColor: '#ff9b04', height: 7, borderRadius: 50},
            tabBarIndicatorContainerStyle: {backgroundColor: 'silver', borderRadius: 50, height: 7, marginTop: 40,},
        }}
      >
